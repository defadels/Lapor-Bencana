...
--
-- Host: localhost:3306
-- Generation Time: Jun 15, 2025 at 05:39 PM
...
INSERT INTO `barang` (`id_barang`, `nama_barang`, `stok_gudang`, `satuan`, `created_at`, `updated_at`) VALUES
(1, 'Beras', 0, 'Kg', '2025-05-26 06:23:33', '2025-05-26 06:23:33');
...
CREATE TABLE `masyarakat` (
  ...
  `status_verify` enum('belum','sudah') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'belum'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `masyarakat` (`nik`, `email`, `nama`, `username`, `password`, `telp`, `kode_otp`, `status_verify`) VALUES
('00998899897888', 'mymail@mail.com', 'James Bond', 'james', '1234', '0812098809818', 0, 'belum'),
('1092979043483794', NULL, 'Anggun Saputri', 'Anggun', '1234', '0898487874738', 0, 'belum'),
('1234', NULL, 'Abay', 'bay', '1234', '0897687', 0, 'belum'),
('123456', NULL, 'Rizki romadon', 'rizki', '$2y$10$1Stb9gbUt00/FMP7ly3LxeE3/', '0897687', 0, 'belum'),
('190281903908', 'madu.ruqyah205@gmail.com', 'Fadhil 2', 'fadhil.adhaa', 'password', '08137690300', 6081, 'sudah'),
('3306020987670098', NULL, 'Ibnu', 'Ibnu', '1234', '089789760098', 0, 'belum'),
('33280102000009', NULL, 'Riski Maulana', 'Rizkii', 'Rizki1234', '081998766678', 0, 'belum'),
('3328061402000001', NULL, 'Bisma Arya', 'Bisma', '1234', '085809877765', 0, 'belum'),
('3328061402000005', NULL, 'Bayu Prakoso', 'Bayu21', 'Bayu1234', '089878677654', 0, 'belum'),
('3328061402010000', NULL, 'Ahmad Yogi', 'Yogi', 'Yogi1234', '081987658876', 0, 'belum'),
('6765798686098079', NULL, 'MUHAMAD YUSUF', 'ucupppp', '1234', '081256435643', 0, 'belum'),
('69874549987', 'fadhil.adhaa26@gmail.com', 'Muhammad Fadhil Adha', 'defadels', 'password', '082273318016', 287027, 'sudah');
...
(24, '2025-05-26', '00998899897888', 'Bojong', 'Jl. Karya', 'Banjir', 'Buang Sampah', '-', '-', '683407e4d7bc4.jpeg', '683407e4d7bc9.mp4', '0');
...
--
ALTER TABLE `pengaduan`
  MODIFY `id_pengaduan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
